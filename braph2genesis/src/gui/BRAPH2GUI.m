...
f = uifigure( ...
    ...
    'Name', [BRAPH2.NAME ' ' BRAPH2.DISTRIBUTION], ...
...
h_text_distribution = text( ...
    'Parent', h_axes, ...
    'Tag', 'H_TEXT_BRAPH2', ...
    'String', ['{\bf\color{black}' BRAPH2.DISTRIBUTION '}'], ...
    'FontSize', BRAPH2.FONTSIZE * 2.0, ...
    'Position', [size(icon, 1)/2 1.1*size(icon, 2)], ...
    'HorizontalAlignment', 'center', ...
    'VerticalAlignment', 'top' ...
    ); %#ok<NASGU>
...
h_text_credits = text( ...
    ...
    'Position', [size(icon, 1)/2 1.25*size(icon, 2)], ...
    'HorizontalAlignment', 'center', ...
    'VerticalAlignment', 'top' ...
    ); %#ok<NASGU>
...
h_button_bluesky = uibutton( ...
    'Parent', f, ...
    'Tag', 'H_BUTTON_BLUESKY', ...
    'Tooltip', 'Open BRAPH 2 Bluesky ...', ...
    'Text', '', ...
    'Icon', imread('icon_bluesky_32px.png'), ...
    'FontSize', BRAPH2.FONTSIZE, ...
    'Position',  [(5*bw)+(12*dw) dh bw bh], ... %[dw+4*(2*dw+bw) dh bw bh], ...
    'ButtonPushedFcn', {@cb_bluesky}, ...
    'BackgroundColor', [1 1 1], ...    
    'Interruptible', 'off', ...
    'BusyAction', 'cancel' ...
    ); %#ok<NASGU>
